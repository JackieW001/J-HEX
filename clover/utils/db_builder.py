...
def dummyUser():
    ...
    addStock(0, "AAPL", 10, 100)
    addStock(0, "AAPL", 10, 101)
    addStock(0, "AAPL", 10, 102)
    addStock(0, "MSFT", 10, 89)
    addStock(0, "MSFT", 10, 91)
    addStock(0, "MSFT", 10, 87)
    removeStock(0, "MSFT", 5, 99)
    removeStock(0, "MSFT", 5, 99)
    removeStock(0, "MSFT", 5, 101)
    removeStock(0, "AAPL", 5, 88)
    removeStock(0, "AAPL", 5, 84)
    removeStock(0, "AAPL", 5, 90)
